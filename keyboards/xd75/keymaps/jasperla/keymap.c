 ...
 * |--------+--------+--------+--------+--------+-----------------+--------+--------+--------+--------+-----------------+--------+--------|
 * | LCTRL  | FN     | LGUI   | LALT   | SPACE  | SPACE  |        |        | PT     | ENTER  | ENTER  | RALT   | RGUI   | FN     | RCTRL  |
 * '--------------------------------------------------------------------------------------------------------------------------------------'
 */
 ...
 [_QW] = { /* QWERTY */
  ...
  { KC_LCTL,  MO(_FN), KC_LGUI, KC_LALT, KC_SPC,  KC_SPC,  _______, _______, MO(_PT), KC_ENT,  KC_ENT,  KC_RALT, KC_RGUI, MO(_FN), KC_RCTL  },
 },
